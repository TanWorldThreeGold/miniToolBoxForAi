        ...
        <div class="flex items-center justify-between pt-2">
          ...
          <div class="flex items-center gap-3">
            <button
              ...
              class="inline-flex items-center gap-1 text-sm text-gray-400 hover:text-blue-500 transition"
            >
...
function exportMarkdown() {
  if (!report.value) return
  let md = `# 日报 ${selectedDate.value}\n\n## 工作摘要\n${report.value.auto_summary || '无'}`
  ...
  a.href = url
  a.download = `日报-${selectedDate.value}.md`
  a.click()
